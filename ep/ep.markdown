...
[Evidential Pluralism](https://blogs.kent.ac.uk/evidential-pluralism/) is a theory of causal enquiry. It maintains that:
...
For a quick introduction to Evidential Pluralism, see [this handout](documents/EP-intro.pdf), or [this podcast](https://www.youtube.com/embed/6smYKKAztKU?si=qrtRnTCckQ2AHEB4&amp;start=85){:target="_blank"}.
...
For overviews, see
<p style="padding-left: 40px;">Joe Jones, Alexandra Trofimov, Michael Wilde &amp; Jon Williamson: <strong>Integrating diverse evidence using Evidential Pluralism: introductory guide, </strong> SSRN, <a href="https://ssrn.com/abstract=6848683" data-wp-editing="1">ssrn.com/abstract=6848683</a></p>
...
<span style="color: #800000">Yafeng Shan & Jon Williamson: </span><strong><a title="Responding to the critical commentaries by Rosa Runhardt, Erik Weber, and Michael Wilde, we defend the application of Evidential Pluralism to the social sciences.">Responses to criticisms</a></strong>, <em> Asian Journal of Philosophy</em> 4(2):80, 2025.  Doi [110.1007/s44204-025-00302-x](https://doi.org/10.1007/s44204-025-00302-x) <a href="https://doi.org/10.1007/s44204-025-00302-x"><img class="alignnone" src="/images/openaccess.jpg" alt="" width="44" height="16" border="0" /></a>
